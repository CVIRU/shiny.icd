...
library("xlsx")
require(rJava)
source("/Users/evaristorodriguez/REU-2018/source/icd9_dx_get_data_v1.R")
source("/Users/evaristorodriguez/REU-2018/source/icd9_sg_get_data_v1.R")
...
t1 <- as.comorbidity_map(split(x = t1$code,
                               f = t1$major))
t1
l2<-comorbid(x = dt.sim,map = t1,visit_name = "Patient_ID", icd_name = "DX1")
l2

...
icd_package_procedure_icd9_v2 <- function() {
  ...
  foreach(i = 1:length(lfile)) %do% {
    # Jack Wasey: can I recommend https://readxl.tidyverse.org/ instead? It has a much lighter dependency load for one thing.
